/*
 * ManageShopcartTag.java
 *
 * Created on February 25, 2005, 11:25 AM
 */
 ...
 */
public class ManageShopcartTag  extends TagSupport  {
    /**
	 * 
	 */
	private static final long serialVersionUID = 598541916285390304L;

	private String page = null;
    
    private String name = "item";
    
    private String activity = "remove";
   ...
   public int doStartTag() throws JspException {
        ...
        if (item == null && !this.activity.equals("enter"))
        ...
        if (!this.activity.equals("enter")) {
            url.append("&shopcartId=");
            //url.append(TagUtils.getInstance().filter(item.getId().toString()));
        }
