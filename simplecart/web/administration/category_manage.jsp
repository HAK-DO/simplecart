...
<html:javascript formName="/PersistCategory" dynamicJavascript="true" staticJavascript="false"/>

<table cellpadding="0" cellspacing="0" border="0">

    <html:form action="/PersistCategory" focus="name" onsubmit="return validateCatalogItemForm(this);">
    <tr>
        <td colspan="3"><bean:message bundle="administration" key="adminMessage.category.manage"/><br></td>
    </tr>
    <tr>
