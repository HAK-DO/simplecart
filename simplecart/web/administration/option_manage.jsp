...
<html:errors/>
<html:javascript formName="/PersistOption" dynamicJavascript="true" staticJavascript="false"/>

<table cellpadding="0" cellspacing="0" border="0">

    <html:form action="/PersistOption" focus="name" onsubmit="return validateCatalogItemForm(this);">
    <tr>
        <td colspan="3"><bean:message bundle="administration" key="adminMessage.option.manage"/><br></td>
    </tr>
    <tr>
        <td colspan="3"><bean:message bundle="administration" key="fieldSection.catalog"/><br></td>
    </tr>
    <tr>
        <td align="right" width="250"><bean:message bundle="administration" key="promptProduct.chooseParent"/></td>
        <td width="10"></td>
        <td width="150">
            <html:select property="productId" name="catalogItemForm">
    ...
    <tr>
        <td colspan="3"><bean:message bundle="administration" key="fieldSection.productOption"/><br></td>
    </tr>
    <tr>
        <td align="right" width="250"><bean:message bundle="administration" key="promptOption.stockKeepingUnitIdentifier"/></td>
        <td width="10"></td>
        <td width="150"><html:text property="stockKeepingUnitIdentifier" size="15" /></td>
    </tr>
    <tr>
        <td align="right" width="250"><bean:message bundle="administration" key="promptOption.unitPriceMSR"/></td>
        <td width="10"></td>
        <td width="150"><html:text property="unitPriceManufacturerSuggestedRetail" size="15" /></td>
    </tr>
    <tr>
        <td align="right" width="250"><bean:message bundle="administration" key="promptOption.unitPriceActualRetail"/></td>
        <td width="10"></td>
        <td width="150"><html:text property="unitPriceActualRetail" size="15" /></td>
    </tr>
    <tr>
        <td align="right" width="250"><bean:message bundle="administration" key="promptOption.unitWeightInOunces"/></td>
        <td width="10"></td>
        <td width="150"><html:text property="unitWeightInOunces" size="15" /></td>
    </tr>
    <tr>
        <td align="right">
